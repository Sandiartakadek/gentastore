        ...
        <div class="bg-green-500 py-6">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                ...
                <div class="flex space-x-4">
                    <!-- Facebook Icon -->
                    <a href="https://www.facebook.com" class="text-white w-7 h-7 p-1 flex items-center justify-center bg-green-600 rounded-full hover:bg-green-700">
                    ...
                    <!-- X Icon -->
                    <a href="https://www.twitter.com" class="text-white w-7 h-7 p-1 flex items-center justify-center bg-green-600 rounded-full hover:bg-green-700">
                        <svg fill="currentColor" viewBox="0 0 24 24" class="w-6 h-6">
                    ...
                    <!-- Instagram Icon -->
                    <a href="https://www.instagram.com" class="text-white w-7 h-7 p-1 flex items-center justify-center bg-green-600 rounded-full hover:bg-green-700">
                        <svg fill="currentColor" viewBox="0 0 24 24" class="w-6 h-6">
